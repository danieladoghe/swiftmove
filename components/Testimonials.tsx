...
const testimonials = [
  {
    ...
    rating: 5,
    text: "Mo's Yard made our cross-country relocation completely stress-free. The crew was professional, careful, and finished 2 hours ahead of schedule. Not a single item was damaged. Absolutely worth every penny.",
    initials: 'SM',
    color: '#f5921e',
  },
  {
    ...
    rating: 5,
    text: "We needed to relocate our entire 40-person office over a weekend. Mo's Yard delivered on every promise — minimal downtime, zero damage, and the team was respectful of our equipment. Outstanding service.",
    initials: 'JT',
    color: '#d97b0c',
  },
  {
    ...
    rating: 5,
    text: "I was nervous about moving from a 4th-floor walk-up, but the Mo's Yard team handled it like pros. Fast, friendly, and their packing supplies from the shop were top-notch. I'll never use another company.",
    initials: 'PR',
    color: '#e8850f',
  },
  {
    ...
    rating: 5,
    text: "I've used Mo's Yard for 3 different property moves now. Consistent quality every single time. The storage solution they offered between moves saved me a fortune. Highly recommend to anyone.",
    initials: 'ML',
    color: '#f5921e',
  },
  {
    ...
    rating: 5,
    text: "Moving with kids is chaotic, but Mo's Yard took so much off our plate. They packed the entire house in one day and were so gentle with our kids' furniture. The quote was exactly what we paid — no surprises.",
    initials: 'EC',
    color: '#d97b0c',
  },
  {
